...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-[#1e293b] via-[#0f172a] to-[#334155] text-white py-12 px-6 shadow-inner shadow-black/30">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row flex-wrap gap-8">

        {/* Section 1 */}
        <div className="md:w-[20%] w-full space-y-4">
          <h2 className="text-2xl font-extrabold tracking-wide text-cyan-400">Library Club</h2>
        ...
        <div className="md:w-[20%] w-full space-y-4">
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            ...
            <li><a href="#" className="hover:text-cyan-400 transition">All Books</a></li>
            <li><a href="#" className="hover:text-cyan-400 transition">Dashboard</a></li>
            <li><a href="#" className="hover:text-cyan-400 transition">My Cart</a></li>
          </ul>
        </div>
        ...
        <div className="md:w-[20%] w-full space-y-4">
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            <li><a href="#" className="hover:text-cyan-400 transition">Support Center</a></li>
        ...
        <div className="md:w-[30%] w-full space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="flex-1 px-5 py-3 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-cyan-400"
            />
      ...
      {/* Bottom Text */}
      <div className="text-center text-gray-400 text-sm mt-12 border-t border-gray-700 pt-6 select-none">
        © {currentYear} <span className="font-semibold text-cyan-400">CCN Library Club</span>. All rights reserved.
      </div>
    </footer>
  );
};
